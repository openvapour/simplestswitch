...
This was implemented on the AS4600 of-dpa for the version of ofdpa found here:
https://github.com/opennetworklinux/ofdpa-2.0-closed-accton/tree/bdb084e89ba2816cd1cd8600ea6a88a275c27afa
I found this ofdpa to be a bit broken with regards to retriving packet ins.
"""
...
class SimplestSwitch13(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        try:
            ...
            ports = [1, 2]
            for port in ports:
                bkt = [parser.OFPBucket(
                       actions=[parser.OFPActionOutput(port)])]
                self.add_group(datapath, bkt,
                               self.l2_unfiltered_if_group(port),
